...
export const Navbar = () => {
  ...
  return (
    <>
      <header class="text-gray-600 dark:text-gray-400 body-font dark:bg-gray-900 shadow-md">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span class="dark:text-white ml-3 text-xl">Quick Poll</span>
          </a>
          <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <Link
              to="/"
              href="/quiz"
              class="mr-5 hover:text-gray-900 dark:hover:text-white"
            >
              Home
            </Link>
          </nav>
          ...
          {isLoggedIn ? (
            <button
              onClick={logoutUser}
              class=" dark:bg-gray-800 dark:hover:bg-gray-700 inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0"
            >
              Log out
              <svg
                fill="none"
